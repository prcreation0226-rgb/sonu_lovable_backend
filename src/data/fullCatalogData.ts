...
export const LIVE_SERVICES = [
  ...
  // 2. Neurotoxins
  { id: "svc-02-01", category_id: "cat-02", name: "Neurotoxins", description: "Botox or Daxxify injections that relax expression muscles to smooth forehead lines, 11s, and crow's feet. Priced per unit.", duration_minutes: 30, price_cents: 1200, price_note: "$12 • per unit (Botox, Jeuveau, Xeomin, Letybo)", is_active: true, display_order: 1 },
  { id: "svc-02-02", category_id: "cat-02", name: "Daxxify", description: "Next-generation neurotoxin that softens expression lines with results that can last up to 6 months.", duration_minutes: 30, price_cents: 800, price_note: "$8 • per unit", is_active: true, display_order: 2 },
  { id: "svc-02-03", category_id: "cat-02", name: "Botox Full Face", description: "Full face neurotoxin treatment targeting forehead, glabella (11s), and crow's feet for a smooth, refreshed look.", duration_minutes: 60, price_cents: 260000, price_note: "$2,600 • comprehensive treatment", is_active: true, display_order: 3 },

  // 3. Medical Wellness
  { id: "svc-03-01", category_id: "cat-03", name: "Hormone Replacement Therapy", description: "Bioidentical HRT consult & treatment (testosterone, estrogen, progesterone, pellets).", duration_minutes: 60, price_cents: 15000, price_note: "$150 • initial consultation • meds, labs & pharmacy billed separately", is_active: true, display_order: 1 },
  { id: "svc-03-02", category_id: "cat-03", name: "GLP-1 Wellness Management — Televisit", description: "Semaglutide / Tirzepatide weight management program.", duration_minutes: 45, price_cents: 25000, price_note: "$250 • $150 evaluation + $100 labs", is_active: true, display_order: 2 },
  { id: "svc-03-03", category_id: "cat-03", name: "Peptide Therapy — Televisit", description: "Peptide therapy including Retatrutide and other compounded peptides.", duration_minutes: 45, price_cents: 25000, price_note: "$250 • Includes evaluation + labs", is_active: true, display_order: 3 },
  { id: "svc-03-04", category_id: "cat-03", name: "GLP-1 Wellness Management — In-Person", description: "Semaglutide / Tirzepatide weight management program in-clinic.", duration_minutes: 45, price_cents: 25000, price_note: "$250 • $150 evaluation + $100 labs", is_active: true, display_order: 4 },
  { id: "svc-03-05", category_id: "cat-03", name: "Peptide Therapy — In-Person", description: "Peptide therapy including Retatrutide and other compounded peptides.", duration_minutes: 45, price_cents: 25000, price_note: "$250 • Includes evaluation + labs", is_active: true, display_order: 5 },
