...
export const LIVE_SERVICES = [
  ...
  { id: "svc-07-04", category_id: "cat-07", name: "Exosomes Add-On", description: "Regenerative growth-factor add-on applied after microneedling or laser to accelerate healing, calm redness, and boost glow, firmness, and tone.", duration_minutes: 15, price_cents: 15000, price_note: "", is_active: true, display_order: 4 },
