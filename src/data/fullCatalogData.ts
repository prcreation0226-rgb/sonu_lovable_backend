...
export const LIVE_SERVICES = [
  ...
  // 6. Chemical Peels
  { id: "svc-06-01", category_id: "cat-06", name: "Light Peel", description: "Gentle, lunchtime-friendly chemical peel that exfoliates the surface to brighten dullness, smooth texture, and even out tone with little to no downtime.", duration_minutes: 45, price_cents: 15000, price_note: "", is_active: true, display_order: 1 },
  { id: "svc-06-02", category_id: "cat-06", name: "Advanced Peel", description: "Stronger medical-grade peel that targets sun damage, pigmentation, fine lines, and uneven texture. Expect light flaking for 3–5 days.", duration_minutes: 60, price_cents: 18500, price_note: "", is_active: true, display_order: 2 },
  { id: "svc-06-03", category_id: "cat-06", name: "Perfect Derma Peel", description: "Signature medium-depth blend peel that improves melasma, sun spots, acne scars, and tone. Visible peeling on days 3–5; results unfold over 2 weeks.", duration_minutes: 60, price_cents: 35000, price_note: "", is_active: true, display_order: 3 },
  { id: "svc-06-04", category_id: "cat-06", name: "TCA CROSS", description: "Focal application of high-concentration TCA into individual icepick and narrow boxcar acne scars to trigger collagen remodeling. Per-session pricing; series of 3–6 typically recommended.", duration_minutes: 45, price_cents: 50000, price_note: "per session · series of 3–6 typically recommended", is_active: true, display_order: 4 },

  // 7. Microneedling
  { id: "svc-07-01", category_id: "cat-07", name: "Pen Microneedling", description: "Automated micro-channels that trigger natural collagen and elastin production to refine pores, fine lines, tone, and superficial scarring. Series of 3 recommended.", duration_minutes: 60, price_cents: 40000, price_note: "", is_active: true, display_order: 1 },
  { id: "svc-07-02", category_id: "cat-07", name: "RF Microneedling", description: "Radiofrequency microneedling that combines collagen-stimulating micro-channels with RF energy deep in the skin to tighten, lift, and resurface. Series of 3 recommended.", duration_minutes: 75, price_cents: 55000, price_note: "", is_active: true, display_order: 2 },
  { id: "svc-07-03", category_id: "cat-07", name: "Subcision (Scar Release)", description: "In-office mechanical release of tethered atrophic and acne scars using a sterile needle or cannula to free fibrous bands and stimulate collagen remodeling.", duration_minutes: 60, price_cents: 65000, price_note: "per session · series of 3–6 typically recommended", is_active: true, display_order: 3 },
  { id: "svc-07-04", category_id: "cat-07", name: "Subcision + Filler/Biostimulator/Booster Add-On", description: "Subcision (manual scar release) combined with an add-on injectable of your choice — HA filler, Sculptra, Radiesse, or skin boosters — to lift and remodel atrophic scars in a single session. Add-on selected and consented at your visit.", duration_minutes: 75, price_cents: 130000, price_note: "Subcision + HA filler — $1,300 · Subcision + Skin booster — $1,050 · Subcision + Radiesse — $1,450 · Subcision + Sculptra — $1,500 (Bundled pricing, all-inclusive per session)", is_active: true, display_order: 4 },
  { id: "svc-07-05", category_id: "cat-07", name: "Exosomes Add-On", description: "Regenerative growth-factor add-on applied after microneedling or laser to accelerate healing, calm redness, and boost glow, firmness, and tone.", duration_minutes: 15, price_cents: 15000, price_note: "", is_active: true, display_order: 5 },
  // 8. Skin Tightening
